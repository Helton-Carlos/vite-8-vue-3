  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="card bg-base-200 shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-sm">Peso Colhido por Mês (kg)</h2>
          <Chart
      ...
      <div class="card bg-base-200 shadow-sm">
        <div class="card-body">
          <h2 class="card-title text-sm">Receita por Mês (R$)</h2>
          <Chart
            :size="{ width: 450, height: 200 }"
            :data="chartData"
            :margin="margin"
    ...
    <div class="card bg-base-200 shadow-sm">
      <div class="card-body">
        <h2 class="card-title text-sm">Registro de Colheitas</h2>
    ...
    >
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="form-control">
          <label class="label"
            ><span class="label-text">Comprador *</span></label
          >
          <input
            v-model="form.buyer"
            type="text"
        ...
        <div class="form-control">
          <label class="label"
            ><span class="label-text">Peso Total (kg)</span></label
          >
          <input
        ...
        <div class="form-control">
          <label class="label"
            ><span class="label-text">Preço por kg (R$)</span></label
          >
          <input
